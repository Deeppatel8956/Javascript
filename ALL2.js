...
const arr34=["May","Jan","May","April","Jan","April"]
function iscountarr(arr) {
    var pair=[]
...
console.log(iscountarr(arr34))

let a=[1,2,3,4]
let deletes=2
let newfilterdeleteanswer=a.filter((ele)=>ele!=deletes)
console.log(newfilterdeleteanswer)

let aq="welcome to my channel"
console.log(aq.split(" ").reverse())

let completestring=[ 'channel', 'my', 'to', 'welcome' ]
console.log(completestring.join(" "))

let str="gold"
console.log(Array.isArray(str))

let a3=[100,200,30,40,500,800]
